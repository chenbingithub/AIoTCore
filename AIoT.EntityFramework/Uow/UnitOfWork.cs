...
namespace AIoT.EntityFramework.Uow
{
    public class UnitOfWork : IUnitOfWork, ITransientDependency
    {
        ...
        public UnitOfWork(IServiceProvider serviceProvider, IOptions<EntityFramework.Uow.AbpUnitOfWorkDefaultOptions> options)
        {
        ...
        public virtual void Initialize(EntityFramework.Uow.AbpUnitOfWorkOptions options)
        {
