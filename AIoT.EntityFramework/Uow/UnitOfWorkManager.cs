...
namespace AIoT.EntityFramework.Uow
{
    public class UnitOfWorkManager : IUnitOfWorkManager, ISingletonDependency
    {
        ...
        public IUnitOfWork Begin(EntityFramework.Uow.AbpUnitOfWorkOptions options, bool requiresNew = false)
        {
        ...
        public void BeginReserved(string reservationName, EntityFramework.Uow.AbpUnitOfWorkOptions options)
        {
        ...
        public bool TryBeginReserved(string reservationName, EntityFramework.Uow.AbpUnitOfWorkOptions options)
        {
            Check.NotNull(reservationName, nameof(reservationName));
